...
export const AgentIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.5,8.25a.75.75,0,0,0-.75.75V12a.75.75,0,0,0,1.5,0V9A.75.75,0,0,0,19.5,8.25Z" />
    <path d="M12,14.25a.75.75,0,0,0,.75-.75V12a.75.75,0,0,0-1.5,0v1.5A.75.75,0,0,0,12,14.25Z" />
    <path d="M4.5,8.25a.75.75,0,0,0-.75.75V12a.75.75,0,0,0,1.5,0V9A.75.75,0,0,0,4.5,8.25Z" />
    <path d="M12,2a10,10,0,1,0,10,10A10,10,0,0,0,12,2ZM18,17.25a3,3,0,0,1-1.88.75H7.88A3,3,0,0,1,6,17.25V15.38a3,3,0,0,1,1.88-.75H8.25V13.5a.75.75,0,0,1,1.5,0v1.13h4.5V13.5a.75.75,0,0,1,1.5,0v1.13h.37A3,3,0,0,1,18,15.38Z" />
  </svg>
);
...
export const SunIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-.386 1.591-1.591M3 12h2.25m.386-6.364 1.591 1.591M12 12a2.25 2.25 0 0 0-2.25 2.25 2.25 2.25 0 0 0 2.25 2.25c.69 0 1.323-.28 1.767-.733.444-.453.733-1.077.733-1.767a2.25 2.25 0 0 0-2.25-2.25Z" />
    </svg>
);
...
export const GeminiIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 17.5a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zM4.5 10a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0z" />
        <path d="M12 6.5a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5z" opacity=".4"/>
        <path d="M19.5 10a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0z"/>
        <path d="M17.15 15.65a2.5 2.5 0 1 0-3.54-3.54 2.5 2.5 0 0 0 3.54 3.54z" opacity=".4"/>
    </svg>
);
